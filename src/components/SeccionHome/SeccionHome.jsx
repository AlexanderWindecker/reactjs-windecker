          ...
          <div className="servicios">
            <div className="carta1">
              ...
              <p>
                ...
                En la <span className="fw-bold">reposteria artesanal</span> todos
                los productos se elaboran a mano y normalmente bajo los
            ...
            <div className="carta3">
              ...
              <p>
                En <span className="fw-bold">Pastelería de diseño</span> ofrecemos
                tortas de vanguardia, decoradas con las últimas tendencias para
                reflejar la elegancia y sofisticación de su próximo evento. Como
